...
/** The CST rooted at `parse` (a semicolon-separated batch of statements); see
 ...
 */
export function parseSqlite(sql: string): ParseResult {
...
function attachErrorCounter(lexer: Lexer, parser: SqliteParser, listener: ANTLRErrorListener): void {
