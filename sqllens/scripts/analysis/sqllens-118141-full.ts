// 118141 真实 Schema 全量血缘正式生成 —— 用 npx tsx sqllens-118141-full.ts 运行
...
writeFileSync("output/118141/sqllens-118141-full-output.txt", out.join("\n"), "utf8");
console.log(out.join("\n"));
console.log("\n\n[已保存] sqllens-118141-full-output.txt");
