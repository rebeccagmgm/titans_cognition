// sql-static-lineage 还原结果 vs 原始 SQL 原文 逐字对照 —— 用 npx tsx scripts/demos/compare-demo.ts 运行
...
const hopsLines = readFileSync("output/118141/sql-static-lineage-118141-hops.txt", "utf-8").split("\n");
