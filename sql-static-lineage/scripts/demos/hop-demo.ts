// sql-static-lineage 逐跳血缘 + 加工逻辑（无损层）实测 —— 用 npx tsx scripts/demos/hop-demo.ts 运行
...
const out = createWriteStream("output/118141/sql-static-lineage-118141-hops.txt", { encoding: "utf8" });
